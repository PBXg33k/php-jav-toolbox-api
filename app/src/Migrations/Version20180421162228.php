...
class Version20180421162228 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE jav_file (id INT AUTO_INCREMENT NOT NULL, hash_id INT DEFAULT NULL, title_id INT DEFAULT NULL, part INT NOT NULL, filename VARCHAR(255) NOT NULL, filesize BIGINT NOT NULL, processed TINYINT(1) NOT NULL, path LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_C32B7B813F7D58D2 (hash_id), INDEX IDX_C32B7B81A9F87BD (title_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
